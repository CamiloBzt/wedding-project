    ...
    <div className="mt-6 p-6 bg-wedding-cream/50 rounded-lg text-center">
      ...
      <div className="space-y-4 text-left max-w-md mx-auto">
        <div className="flex items-start gap-3">
          <span className="flex-shrink-0 w-6 h-6 bg-wedding-olive text-wedding-gold rounded-full flex items-center justify-center text-sm font-bold">
            1
          </span>
      ...
      <button
        ...
        className="mt-4 px-6 py-2 bg-gradient-to-r from-wedding-olive-dark to-wedding-olive text-wedding-gold rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
      >
